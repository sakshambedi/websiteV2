...
export default function Loading({ onComplete }: LoadingProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen w-screen font-mono">
            <div>
                <pre
                    id="loadingScreen"
                    ref={loadingScreenRef}
                    className="whitespace-pre text-sm leading-tight text-gray-950 dark:text-gray-300 w-[80ch] mx-auto"
                ></pre>
            </div>
