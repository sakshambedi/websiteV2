  ...
  return (
    <section className="flex w-full flex-col items-center justify-center font-mono">
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="text-sm text-left dark:text-gray-400 text-gray-600 pl-0 phone:px-0 phone:text-xs">
              date
            </TableHead>
            <TableHead className="text-sm text-left dark:text-gray-400 text-gray-600 phone:text-xs phone:px-1">
              title
            </TableHead>
            <TableHead className="text-sm text-right dark:text-gray-400 text-gray-600 pr-0 phone:text-xs phone:px-0">
              category
            </TableHead>
          </TableRow>
        </TableHeader>
