...
export default function WorkContent() {
    return (
        <section>
            ...
            <h3 className="font-serif text-2xl pt-5 md:pt-2  phone:pt-3 phone:text-xl">Work Mission</h3>
            ...
            <div className="pt-10 ">
                <h3 className="font-serif text-2xl  pt-2  phone:text-xl phone:pt-1.5 ">Technical Analyst and Project Coordinator</h3>
                <h4 className="text-base font-mono phone:font-base dark:text-gray-300" >Daemon Defense Systems, 2022 - Present</h4>
            ...
            <div className="pt-10">
                <h3 className="font-serif text-2xl  font-base  pt-2  phone:text-xl phone:pt-1.5 ">Software Developer Intern</h3>
