...
export default function HomeContent() {
    return (
        <div className="item-center w-full ">
            <p className="text-base font-mono phone:text-sm ">Hi!👋🏼</p>
            ...
            <div className="pt-10">
                <h1 className="font-serif text-2xl pt-5 md:pt-2 md:text-2xl phone:pt-3 phone:text-xl">Skills</h1>
            ...
            <div className="pt-10">
                <h2 className="font-serif text-2xl pt-5 md:pt-2 md:text-xl phone:pt-3 phone:text-xl">Projects</h2>

                <div className="project-info">
                    <div className="flex flex-row justify-between  font-mono text-lg  font-base  pt-2  space-x-5 phone:space-x-3 phone:pt-1.5 md:pt-2 md:space-x-3">
                        <h3 className='text-lg  phone:text-base md:text-basetext-left'>Vortex - AI Classification</h3>
                    ...
                    <div className='flex flex-row flex-wrap pt-5 phone:pt-4 justify-start gap-10 phone:gap-7 box-border w-full md:gap-9'>
                        <Image
                ...
                <div className="pt-7">
                    <div className="flex flex-row justify-between  font-mono text-lg  font-base  pt-2  space-x-5 phone:space-x-3 phone:pt-1.5 md:pt-2 md:space-x-3">
                        <h3 className='text-lg phone:text-base md:text-base text-left'>NanoGTP NLP Model</h3>
            ...
            <div className="pt-10">
                <h1 className="font-serif text-2xl pt-5 md:pt-2 md:text-xl phone:pt-3 phone:text-xl">Education</h1>
                <div>
                    <h3 className=" font-mono text-lg    pt-2  phone:text-sm phone:pt-1.5">B.Sc. in Computer Science, 2020 - 2025</h3>
                    <p className=" font-mono text-sm  phone:text-sm pt- md:pt-0 phone:pt-1.5">University of Manitoba
                    </p>
                </div>
            </div>
