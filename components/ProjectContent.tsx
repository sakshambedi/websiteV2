            ...
            <div className="pt-0">
                ...
                <div className="project-info">
                    <div className="flex flex-row justify-between  font-mono   pt-2  space-x-5 phone:space-x-3 phone:pt-1.5 md:pt-2 md:space-x-3">
                        <h3 className='text-xl font-rebondG phone:font-base pt-2 md:pt-2 phone:pt-1  text-black dark:text-white'>Vortex - AI Classification</h3>
                ...
                <div className="pt-10">
                    <div className="flex flex-row justify-between  font-mono text-lg  font-base  pt-2  space-x-9 phone:space-x-3 phone:pt-1.5 md:pt-2 md:space-x-3">
                        <h3 className='text-xl font-rebondG phone:font-base pt-2 md:pt-2 phone:pt-1 text-black dark:text-white'>NanoGTP NLP Model</h3>
